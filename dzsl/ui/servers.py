...
import threading
from dzsl.core.config import load_json, save_json, FILTERS_FILE
...
from dzsl.ui.ping import ping_servers

log = get_logger("servers")

load_environment(ENV_FILE)
API_URL = os.getenv("API_URL", DEFAULT_LIST_URL)
