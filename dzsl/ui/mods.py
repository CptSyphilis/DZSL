...
from dzsl.core.config import get_installed_mods, mod_subscribed, workshop_dirs
...
class ModsView:
    ...
    def _fetch_creator_profiles(self, creator_ids):
        ...
        if missing and STEAM_API_KEY:
            try:
                players = player_summaries(missing, STEAM_API_KEY)
        ...
        def check_updates(b):
            ...
            def _check():
                ...
                try:
                    ...
                    details = published_file_details(ids, timeout=120)
                    for d in details:
    ...
    def _request_workshop_details(self, mod_ids):
        ...
        def fetch():
            try:
                ...
                dependency_names = {}
                if dependency_ids:
                    for item in published_file_details(sorted(dependency_ids), timeout=120):
